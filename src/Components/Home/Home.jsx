          ...
          >
            ...
            >
              ...
              <div className="max-w-4xl mb-32 md:mb-8" >
                <h4
                  className="text-[12rem] md:text-6xl font-albert-sans font-bold md:font-semibold md:w-[28.25rem] leading-[1.2]"
              ...
              <div className="flex" data-astro-cid-ehvcvm4h="">
                ...
                <div className="flex flex-row" data-astro-cid-ehvcvm4h="">
                  ...
                  <div
                    className="hidden md:block ml-5 font-medium text-5xl md:text-base font-sans mt-4 cursor-pointer hover:text-primary"
              ...
              <div className="flex flex-col items-center justify-center w-full">
                ...
                <img src="https://www.ombrulla.com/_astro/ai-visual-inspection_banner_1.f3232628_ZyIKMH.webp" alt="AI visual inspection" className="mask-image"/>
                </div>
