...
function Header() {
  return (
    <div className="header">
        ...
        <nav>
          <div class="px-20 md:px-24 bg-invisible max-w-none">
                ...
                <div className="flex items-center">
                  <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4 text-black ">
                      <a
                        href="/"
                        className="rounded-md px-3 py-2 font-bold font-sans text-primary hover:text-primary"
                      >
                        Home
                      </a>
                      <div className="relative group mt-2 ">
                        <a
                          href="#"
                          className="dropdown-link rounded-md font-bold font-sans text-black flex flex-row hover:text-primary"
                        >
                          <span>Services</span>
