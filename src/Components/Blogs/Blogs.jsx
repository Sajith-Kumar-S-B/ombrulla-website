          ...
          <div className="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
              ...
              >
                ...
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                  Google I/O 2023 envisions a future where helpful AI integrates
                  seamlessly into our lives, breaking down barriers, empowering
                  individuals, and tackling global challenges. By developing AI
                  responsibly, we can shape a future where everyone benefits.
                </p>
              </a>
            ...
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
                ...
                <span className="inline-flex items-center px-3 py-0.5 rounded-lg text-sm font-medium">
                  <div className="overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="A Deep Understanding of AI Visual Inspection"
                      className="w-full h-full object-cover"
                      width="1366"
                      height="768"
                      loading="lazy"
              ...
              >
                ...
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                  The primary objective of this blog is to offer a foundational
                  comprehension of automated visual evaluation and elucidate how
                  AI Visual Inspection techniques contributes to significant
            ...
            <div className="bg-white p-5 rounded-lg grid grid-rows-1 md:grid-rows-2">
                ...
                <span className="inline-flex items-center px-3 py-0.5 rounded-lg text-sm font-medium">
                  <div className="overflow-hidden rounded-lg">
                    <img
                      ...
                      alt="Use of AI in Process Optimization and Quality Control"
                      className="w-full h-full object-cover"
                      width="1366"
                      height="768"
                      loading="lazy"
              ...
              >
                ...
                <p className="mt-3 text-2xl md:text-base text-gray-500">
                  AI Visual Inspection is increasingly being used in process
                  optimization and quality control across a range of industries,
                  including manufacturing, healthcare, and logistics.
                </p>
              </a>
              <div className="flex row-span-1 place-items-center">
                <div className="flex-shrink-0">
